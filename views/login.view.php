                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" spellcheck="false">
                            ...
                            <div class="input-group form-group">
                                <input type="url" class="form-control" placeholder="mongodb://user:pass@host:port/db" title="URI" name="uri" pattern="^mongodb(\+srv)?://.+$" <?php if($url=getenv('MONGO_URL')) { echo 'value="'.$url.'"'; } ?> required>
                            </div>
